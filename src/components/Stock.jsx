      ...
      <div className="bg-white rounded-2xl shadow-md border border-gray-200 overflow-hidden">
        ...
        <div className="px-6 py-3 bg-blue-50 border-b border-blue-100 flex justify-between items-center">
          ...
          <p className="text-gray-600">
            ...
            of{' '}
            <span className="font-medium">{searchTerm ? filteredData.length : stock.length}</span>
          </p>
        </div>
                ...
                <React.Fragment key={`${curStock.fabricNumber}-${i}`}>
                  <tr className="hover:bg-gray-50 transition">
                    ...
                    <td className="px-6 py-4">
                      <div
                        className={`px-3 py-1 rounded-full text-xs font-semibold flex justify-between ${
                          curStock.availableStock > 100
